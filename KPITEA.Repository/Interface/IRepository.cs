...
namespace KPITEA.Repository.Interface
{
    public interface IRepository<T> : IDisposable where T : class
    {
        ...
        /// <returns>Entities with Eager loaded selected relations</returns>
        IQueryable<T> GetAllIncluding(string includedProperties, Boolean EnableTacking = false);
        ...
        IQueryable<T> ExecProcedureWithParam(string query, params object[] parameters);
        IQueryable<T> ExecProcedure(string query);
    }
}
